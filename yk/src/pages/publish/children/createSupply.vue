...
<div class="createTender_page">
	...
	<header-top title='发布供应' back></header-top>
            ...
            <form action="" class="form-container layui-form">
                ...
                <div class="form-group radio-group">
                    ...
                    <p style="display: inline-block;">
                        <input id="type1" lay-ignore @click="order.sType='全新' " type="radio" style="opacity:0!important;" name="type-order"/>
                        <label for="type1" class="type-icon"></label>全新
                    </p>

                    <p style="display:inline-block;">
                        <input id="type2" checked @click="order.sType='旧' " type="radio" style="opacity:0!important;" name="type-order"/>
                ...
                <div class="form-group univalent">
                    ...
                    <input type="number" lay-verify="sPrice" v-model:value="order.sPrice"  placeholder="必填，价格面议请写0"/>
...
<!--                 <div class="form-group icon-gt">
 ...
 -->
                ...
                <div class="form-group icon-gt">
                    ...
                    <input type="text" readonly lay-verify="endDate" @click="alertSelectBox(5)"  v-model:value="order.sDate" placeholder="必填"/>
                </div>
                ...
                <div class="form-group image-group main-img" id="upload1">
                    ...
                    <!-- 上传图片组件框 -->
                    <drop-zone id="myVueDropzone" class="myVueDropzone10" ref='uploadImg' :useFontAwesome="false" enctype="multipart/form-data" methods='post' 
...
<!--                     <div style='display:none;' class="dz-default dz-message">
                    ...
                    <div v-show=" uploadSwitch " class="img-upload-box1 dz-default dz-message dz-supply">
                ...
                <div id="upload2" class="form-group image-group info-img">
                    ...
                    <!-- 上传图片组件框 -->
                    <drop-zone id="myVueDropzone2" class="myVueDropzone10" ref='uploadImg2' :useFontAwesome="true" enctype="multipart/form-data" methods='post' 
                      :autoProcessQueue=false
                      :maxFileSizeInMB=10
                      :showRemoveLink=true
                    ...
                    <div v-show=" uploadSwitch2 " class="img-upload-box1 dz-default dz-message dz-supply">
  ...
  <div class="selectBox" id='selectBox' v-if=" showSelectBox ">
    ...
    <div class="selectBox_cell" v-show=" showSelectBoxId == 6 ">
      ...
      <ul>
        ...
        <li v-for="item in 30" @click="endTime = item" v-text="item"></li>
        <li @click="endTime = 60">60</li>
        <li @click="endTime = 90">90</li>
        <li @click="endTime = 120">120</li>
        <li @click="endTime = 150">150</li>
        <li @click="endTime = 180">180</li>
...
import {showRule3,uploadUrl,checkAuthen2} from '@/tool/tool'
...
export default{
  ...
  mounted(){
    ...
    this.$nextTick(()=>{
      ...
      // this.scroller = new bScroll("#swiper",{
      //   click:true,
      //   bounce:false,//回弹
      //   momentum: true,//惯性滑动
      // })
  ...
  methods:{
    ...
    submitForm(){
      ...
      this.$http.post('/addSupply',this.order).then((res)=>{
        //后台传来结果，关闭加载动画
        layer.closeAll();
        let vm = this;
        if(res.data.code==0){
  ...
  .form-box{
    ...
    .image-group{
      ...
      .img-upload-box1{
        /*margin-bottom:10px;*/
        background: #f0f0f0;
        height:80/@root-font-size !important;
        margin:.2rem;
        position: relative;
        /*padding:10px 0;*/
        overflow: hidden;
...
#upload1,#upload2{
  ...
  .myVueDropzone10{
	...
	.dz-supply{
		height:89/@root-font-size !important;
		width:89/@root-font-size !important;
	}
    .dz-image{
      /*height:auto;*/
      display: flex;
